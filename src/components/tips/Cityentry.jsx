function Cityentry() {
    return(
        <div className="px-5 prose max-w-none text-black dark:text-white">
            <h2 className="px-10 mb-10 dark:text-white text-black">Connection to the highway</h2>
            ...
            <h3 className="mt-5 mb-2 dark:text-white text-black">A roundabout</h3>
            <p className="text-justify">
                This is the most common solution and it helps you quickly start a new city and get the ideas out there. Build a simple 2 way road, and the one way road will unlock. Now you can <a href="/" className="dark:text-white dark:underline-white text-black">build your own roundabout</a>. Depending on your city development, it will have to be replaced eventually, so leave plenty of space for an upgrade.
            </p>
            
            <h3 className="mt-5 mb-2 dark:text-white text-black">Avenue</h3>
            <p className="text-justify">
            ...
            <h3 className="mt-5 mb-2 dark:text-white text-black">Interchange(M)</h3>
            <p className="text-justify">
