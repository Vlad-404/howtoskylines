function Cityentry() {
    return(
        <div className="px-5 prose prose-slate max-w-none">
            <h2 className="px-10 mb-10">Connection to the highway</h2>
            ...
            <h3 className="mt-5 mb-2">A roundabout</h3>
            <p class="text-justify">
                This is the most common solution and it helps you quickly start a new city and get the ideas out there. Build a simple 2 way road, and the one way road will unlock. Now you can <a href="#">build your own roundabout</a>. Depending on your city development, it will have to be replaced eventually, so leave plenty of space for an upgrade.
            </p>
            
            <h3 className="mt-5 mb-2">Avenue</h3>
            <p class="text-justify">
            ...
            <h3 class="mt-5 mb-2">Interchange(M)</h3>
            <p class="text-justify">
