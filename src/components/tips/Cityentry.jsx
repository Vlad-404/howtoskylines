function Cityentry() {
    return(
        <div className="px-5">
            <h1 className="px-10 mb-10 text-3xl">Connection to the highway</h1>
            ...
            <h2 className="mt-5 mb-2 text-2xl">A roundabout</h2>
            <p class="text-justify">
                This is the most common solution and it helps you quickly start a new city and get the ideas out there. Build a simple 2 way road, and the one way road will unlock. Now you can <a href="#" className="text-sky-400 underline">build your own roundabout</a>. Depending on your city development, it will have to be replaced eventually, so leave plenty of space for an upgrade.
            </p>
            
            <h2 className="mt-5 mb-2 text-2xl">Avenue</h2>
            <p class="text-justify">
            ...
            <h2 class="mt-5 mb-2 text-2xl">Interchange(M)</h2>
            <p class="text-justify">
